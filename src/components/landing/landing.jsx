...
export default function Landing() {
  ...
  return <section id="home" className="landing" onMouseMove={moveGlow} onMouseEnter={() => setActive(true)} onMouseLeave={() => setActive(false)}>
    ...
    <div className="hero-content">
      ...
      <motion.div className="hero-bottom" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .75, duration: .65 }}><p>Building reliable infrastructure, real-time systems, and AI-powered products.</p><div className="hero-actions"><a href="#projects" className="hero-link">See the work <b>↓</b></a><a href="#arcade" className="hero-play">Take a play break <span aria-hidden="true">↗</span></a></div></motion.div>
    </div>
