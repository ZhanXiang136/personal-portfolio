...
const experience = [
  ...
  { organization: 'JPMorgan Chase & Co.', role: 'Junior Coder', date: 'Oct 2021 — Jul 2023', details: ['Built and deployed an NLP-powered AI chatbot with Elasticsearch classification and retrieval, reducing on-call support load by an estimated 50%.', 'Designed race-safe task allocation and FastAPI services with CI/CD, then presented the solution to 10+ internal platform teams.'] },
];
